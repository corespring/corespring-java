...
You can find the latest corespring-java jar [here](https://github.com/corespring/corespring-java/raw/releases/org/corespring/corespring-java/0.3.1/corespring-java-0.3.1.jar) and include it on your classpath.
