...
You can find the latest corespring-java jar [here](https://github.com/corespring/corespring-java/raw/releases/org/corespring/corespring-java/0.3.28.4/corespring-java-0.3.28.4.jar) and include it on your classpath.
